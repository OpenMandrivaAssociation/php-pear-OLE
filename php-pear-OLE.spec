...
install %{_pearname}-%{version}/OLE.php %{buildroot}%{_datadir}/pear/
install %{_pearname}-%{version}/PPS.php %{buildroot}%{_datadir}/pear/%{_class}
install %{_pearname}-%{version}/PPS/*.php %{buildroot}%{_datadir}/pear/%{_class}/PPS
